      ...
      <main className="grow py-20 bg-surface">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-extrabold mb-4">Remove Pages from PDF</h1>
            <p className="text-gray-500 font-medium">Select pages to remove from your PDF document.</p>
          </div>
                ...
                <div className="lg:w-1/3 w-full">
                  <div className="bg-gray-50 rounded-2xl p-6 sticky top-20">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-sm font-bold text-gray-700 wrap-break-word">
