  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div 
        ...
        onDrop={handleDrop}
        className={cn(
          "border-2 border-dashed rounded-[2rem] p-12 text-center transition-all group",
          files.length > 0 ? "border-primary/20 bg-primary/[0.02]" : "border-gray-100 bg-white hover:border-primary/20",
