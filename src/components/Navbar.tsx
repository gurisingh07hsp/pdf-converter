...
//   { title: "TIFF to PDF", href: "/convert/tiff-to-pdf", icon: ImageIcon, color: "text-orange-600" },
...
//   { title: "PDF to ZIP", href: "/convert/pdf-to-zip", icon: File, color: "text-green-500" },
// ];
...
//   { title: "Repair PDF", href: "/repair-pdf", icon: Settings, color: "text-red-500" },
// ]
...
//   { title: "Protect PDF", href: "/protect-pdf", icon: LockKeyhole, color: "text-orange-600" },
//   { title: "Unlock PDF", href: "/unlock", icon: UnlockKeyhole, color: "text-pink-500" },
...
const menuColumns = [
  { label: "Merge & Edit", items: mergeAndEdit },
  { label: "Optimize & Extract", items: optimizeAndExtract },
  { label: "Convert To PDF", items: convertToPdf },
  { label: "Convert From PDF", items: convertFromPdf },
  { label: "PDF Security", items: pdfSecurity },
];
...
export default function Navbar() {
  ...
  // Using a small close-delay bridges the gap between the trigger button and
  // the fixed-position panel below it, so quickly moving the cursor down
  // into the dropdown no longer causes it to vanish before you get there.
    ...
    <>
          ...
          >
            ...
            {isDropdownOpen && (
              <div
                onMouseEnter={openDropdown}
                onMouseLeave={scheduleClose}
                className="fixed left-0 right-0 top-16 bg-white border-t border-gray-200 shadow-2xl z-50"
              >
                <div className="max-w-7xl mx-auto flex gap-2 p-6">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 bg-white mt-16 md:hidden flex flex-col">
          <div className="flex-1 overflow-y-auto p-4">
            <div className="flex flex-col gap-4 mb-6">
              <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                Home
              </Link>
              <Link href="/pricing" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                Pricing
              </Link>
              <Link href="/blog" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                Blog
              </Link>
              <Link href="/about" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                About
              </Link>
              <Link href="/faq" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                FAQ
              </Link>

              {user && user.role == "admin" && (
                <Link href="/admin" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-medium text-gray-500 hover:text-foreground transition-colors">
                  Admin
                </Link>
              )}
            </div>
